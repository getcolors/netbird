...
resource "vultr_ssh_key" "machine" {
  name    = "netbird-fixture"
  ssh_key = trimspace(file("/home/build-placeholder/.ssh/netbird-fixture.pub"))
}
...
resource "vultr_firewall_group" "netbird" {
  description = "netbird-fixture-firewall"
}
...
resource "vultr_instance" "netbird" {
  ...
  connection {
    ...
    user = "root"
    host = self.main_ip
    private_key = file("/home/build-placeholder/.ssh/netbird-fixture")
  }
